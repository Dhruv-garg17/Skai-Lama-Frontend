    ...
    return (
        <div className="flex flex-col h-screen bg-white p-5">
            ...
            <div className="flex justify-between w-full p-5">
                <img src={quesAipurpleLogo} alt="logo"  className='w-[200px] h-[42px]'/>
                <div className="flex space-x-4">
                    <button className="text-gray-600 "><svg width="50" height="50" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className="text-gray-600 "><svg width="50" height="50" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {projects.length === 0 ? (
                <div className='m-auto text-center flex flex-col items-center'>
                    ...
                    <p className="text-center text-gray-600 max-w-lg mb-6">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Recusandae doloribus inventore repudiandae, sapiente animi sit officiis corrupti amet, aut minus suscipit architecto totam ducimus. Reiciendis pariatur officiis voluptatem molestiae recusandae?
                    </p>
                    <button
                ...
                <div className='p-10'>
                    <div className="flex justify-between">
                        <h1 className="text-3xl font-semibold text-purple-700 mb-6">Projects</h1>
                        <button
                            className="bg-black text-white py-2 px-6 rounded-md items-center flex gap-2"
                            onClick={() => setIsModalOpen(true)}
                        >
